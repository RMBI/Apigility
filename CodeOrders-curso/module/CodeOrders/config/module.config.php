...
return array(
    ...
    'input_filter_specs' => array(
        ...
        'CodeOrders\\V1\\Rest\\Clients\\Validator' => array(
            ...
            1 => array(
                ...
                'error_message' => 'Preencha o campo document',
            ),
            2 => array(
                'name' => 'address',
                'required' => true,
                ...
                'error_message' => 'Preencha o campo endereço',
            ),
            3 => array(
                'name' => 'zipcode',
                'required' => true,
                'filters' => array(),
                'validators' => array(),
                'error_message' => 'Preencha o campo CEP',
            ),
            4 => array(
                'name' => 'city',
                'required' => true,
                ...
                'error_message' => 'Preencha o campo cidade',
            ),
            5 => array(
                'name' => 'state',
                'required' => true,
                'filters' => array(),
                'validators' => array(),
                'error_message' => 'Preencha o campo Estado',
            ),
            6 => array(
                'name' => 'responsible',
                'required' => true,
                ...
                'error_message' => 'Preencha o campo Responsavel',
            ),
            7 => array(
                'name' => 'email',
                'required' => true,
                ...
                'error_message' => 'Preencha o campo e-mail',
            ),
            8 => array(
                'name' => 'phone',
                'required' => true,
                ...
                'error_message' => 'Preencha o campo Telefone',
            ),
            9 => array(
                'name' => 'obs',
                'required' => false,
                ...
                'error_message' => 'Preencha o campo Observação',
            ),
        ),
    ),
    'service_manager' => array(
        'factories' => array(
            ...
            'CodeOrders\\V1\\Rest\\Users\\UsersRepository' => 'CodeOrders\\V1\\Rest\\Users\\UserRepositoryFactory',
